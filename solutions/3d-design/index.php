...
<body>
	...
	<div class="container main-container">
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					<div class="container listing-panel">
						<a href="PDT010/">
							<div>
								<img src="/wigwam/images/systems/h.png" />
							</div>
						</a>
						<div>
							<ul>
								<li>Intel Core i9 9900K 3.6GHz 8 Core CPU</li>
								<li>16GB DDR4 2666MHz RAM</li>
								<li>NVIDIA Quadro P2000 5GB Graphics</li>
								<li>512GB SSD</li>
								<li>4TB Hard Drive</li>
							</ul>
						</div>
						<div>
							<a href="/wigwam/solutions/PDT010" class="customize-button">Customize</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
