			...
			<form method="get" name="orderform" action="/wigwam/submitconfig.php" class="row" id="form">
				...
				<div class="col-md-9">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="mobo" id="mobo" value="MBD001">
								<a target="_blank" href="#">ASUS ROG STRIX Z390-I (Intel Z370 Mini-ITX)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="cpu" id="cpu" onchange="get_options('cpu'); get_total();">
									<optgroup>
										<option value="CPU003"></option>
										<option value="CPU004"></option>
										<option selected value="CPU005"></option>
									</optgroup>
								</select>
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="gpu" id="gpu" onchange="get_options('gpu'); get_total();">
									...
									<optgroup>
										<option selected value="GPU013"></option>
							...
							<div class="alert alert-info alert-condensed">
								Many 3D Design applications only officially support NVIDIA Quadro cards, although in some instances (primarily game development and GPU rendering) a GeForce card may be desired.
							</div>
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="chassis" id="chassis" value="CHS001">
								<a target="_blank" href="#">Silverstone FTZ01 Mini ITX (black)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="psu" id="psu" value="PSU001">
								<a target="_blank" href="#">Corsair SF600 600W SFX (80 PLUS Gold)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="cooler" id="cooler" value="CLR001">
								<a target="_blank" href="#">Noctua NH-L12S Low Profile CPU Cooler (Intel 115x)</a>
							</div>
						</div>
					</div>
					<div class="row">
