	...
	<div class="container main-container">
		<div class="container">
			<form method="get" name="orderform" action="/wigwam/submitconfig.php" class="row" id="form">
				<input type="hidden" name="product" id="product" value="PDT008">
				<div class="col-md-9">
					<div class="row">
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="gpu" id="gpu" onchange="get_options('gpu'); get_total();">
									...
									<optgroup>
										<option value="GPU012"></option>
										<option value="GPU013"></option>
										<option value="GPU026"></option>
							...
							<div class="input-group input-group-sm">
								<select class="form-control" name="drive2" id="drive2" onchange="get_options('drive2'); get_total();">
									...
									<optgroup>
										...
										<option selected value="HDD007"></option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								...
								<a target="_blank" href="#">Noctua NH-U12DX i4 Socket Cooler (Intel 2011)</a>
							</div>
						</div>
					</div>
					<div class="row">
