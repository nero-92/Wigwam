	...
	<div class="container main-container">
		<div class="container">
			<form method="get" name="orderform" action="/wigwam/submitconfig.php" class="row" id="form">
				<input type="hidden" name="product" id="product" value="PDT007">
				<div class="col-md-9">
					<div class="row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="mobo" id="mobo" value="MBD005">
								<a target="_blank" href="#">Gigabyte X299 Designare (Intel X299 ATX DDR4 Thunderbolt)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="cpu" id="cpu" onchange="get_options('cpu'); get_total();">
									<optgroup>
										<option value="CPU009"></option>
										<option value="CPU010"></option>
										<option value="CPU011"></option>
										<option value="CPU012"></option>
										<option value="CPU013"></option>
										<option value="CPU014"></option>
										<option value="CPU015"></option>
									</optgroup>
								</select>
							...
							<div class="input-group input-group-sm">
								<select class="form-control" name="gpu" id="gpu" onchange="get_options('gpu'); get_total();">
									<optgroup>
										...
										<option value="GPU004"></option>
										<option value="GPU005"></option>
										<option selected value="GPU006"></option>
										<option value="GPU007"></option>
										<option value="GPU008"></option>
										<option value="GPU009"></option>
										<option value="GPU010"></option>
										<option value="GPU011"></option>
									</optgroup>
									<optgroup>
										<option value="GPU020"></option>
										<option value="GPU021"></option>
										<option value="GPU022"></option>
										<option value="GPU023"></option>
										<option value="GPU024"></option>
										<option value="GPU025"></option>
									</optgroup>
								</select>
								<span class="input-group-append">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="drive4" id="drive4" onchange="get_options('drive4'); get_total();">
									<optgroup>
										<option value="NONE"></option>
									</optgroup>
									<optgroup>
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="optic" id="optic" onchange="get_options('optic'); get_total();">
									...
									<optgroup>
										<option selected value="OPT003"></option>
										<option value="OPT004"></option>
									</optgroup>
								</select>
								<span class="input-group-append">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="chassis" id="chassis" value="CHS003">
								<a target="_blank" href="#">Fractal Design Define R6 USB-C (black)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="psu" id="psu" value="PSU004">
								<a target="_blank" href="#">EVGA SuperNOVA P2 1000W (80 PLUS Platinum)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="cooler" id="cooler" value="CLR003">
								<a target="_blank" href="#">Corsair Hydro H60 Liquid Cooling System (Intel 2011)</a>
							</div>
						</div>
					</div>
					<div class="row">
