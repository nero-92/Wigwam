	...
	<div class="container main-container">
		<div class="container">
			<form method="get" name="orderform" action="/wigwam/submitconfig.php" class="row" id="form">
				<input type="hidden" name="product" id="product" value="PDT003">
				<div class="col-md-9">
					<div class="row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="mobo" id="mobo" value="MBD003">
								<a target="_blank" href="#">Gigabyte Z390 Aorus Pro WiFi (Intel Z390 ATX)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
