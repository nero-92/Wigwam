	...
	<div class="container main-container">
		<div class="container">
			<form method="get" name="orderform" action="/wigwam/submitconfig.php" class="row" id="form">
				<input type="hidden" name="product" id="product" value="PDT002">
				<div class="col-md-9">
					<div class="row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="mobo" id="mobo" value="MBD002">
								<a target="_blank" href="#">Asus P10S-M WS (Intel C236 mATX)</a>
							</div>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="cpu" id="cpu" onchange="get_options('cpu'); get_total();">
									<optgroup>
										<option value="CPU006"></option>
										<option selected value="CPU007"></option>
										<option value="CPU008"></option>
									</optgroup>
								</select>
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="ram" id="ram" onchange="get_options('ram'); get_total();">
									<optgroup>
										<option value="RAM004"></option>
										<option selected value="RAM005"></option>
										<option value="RAM006"></option>
										<option value="RAM007"></option>
									</optgroup>
								</select>
								<span class="input-group-append">
						...
						<div class="col-sm-9">
							<div class="input-group input-group-sm">
								<select class="form-control" name="gpu" id="gpu" onchange="get_options('gpu'); get_total();">
									<optgroup>
										<option value="GPU018"></option>
									</optgroup>
									<optgroup>
										<option value="GPU002"></option>
										<option selected value="GPU003"></option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								<input type="hidden" name="net" id="net" value="NET004">
								<a target="_blank" href="#">2x Gigabit LAN (Intel I201)</a>
							</div>
						</div>
					</div>
					<div class="row">
