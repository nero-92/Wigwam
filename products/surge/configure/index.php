	...
	<div class="container main-container">
		<div class="container">
			<form method="get" name="orderform" action="/wigwam/submitconfig.php" class="row" id="form">
				<input type="hidden" name="product" id="product" value="PDT006">
				<div class="col-md-9">
					<div class="row">
							...
							<div class="input-group input-group-sm">
								<select class="form-control" name="cpu" id="cpu" onchange="get_options('cpu'); get_total();">
									...
									<optgroup>
										...
										<option selected value="CPU004"></option>
					...
					<div class="form-group row">
						...
						<div class="col-sm-9">
							<div class="checkbox">
								...
								<a target="_blank" href="#">Corsair Hydro H60 Liquid Cooling System (Intel 115x)</a>
							</div>
						</div>
					</div>
					<div class="row">
