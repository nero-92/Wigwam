...
<head>
	...
	<script>
		var parts = <?php echo get_parts_list('103'); ?>;
	</script>
...
<body>
	...
	<div class="container">
		<form method="get" name="orderform" action="../submitconfig.php" class="row" id="form">
			<input type="hidden" name="product" id="product" value="103">
			<div class="col-md-9">
				<div class="row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="checkbox">
							<input type="hidden" name="mobo" id="mobo" value="11003">
						...
						<div class="input-group input-group-sm">
							<select class="form-control" name="cpu" id="cpu" onchange="get_options('cpu'); get_total();">
								<optgroup>
									...
									<option value="12003"></option>
									<option value="12004"></option>
									<option value="12005"></option>
								</optgroup>
							</select>
					...
					<div class="col-sm-9">
						<div class="input-group input-group-sm">
							<select class="form-control" name="ram" id="ram" onchange="get_options('ram'); get_total();">
								<optgroup>
									<option value="13005"></option>
									<option value="13006"></option>
									<option value="13007"></option>
								</optgroup>
							</select>
							<span class="input-group-append">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="input-group input-group-sm">
							<select class="form-control" name="gpu" id="gpu" onchange="get_options('ram'); get_total();">
								<optgroup>
									<option value="14003"></option>
									<option value="14004"></option>
									<option value="14005"></option>
									<option value="14006"></option>
									<option value="14007"></option>
									<option value="14008"></option>
								</optgroup>
							</select>
							<span class="input-group-append">
								<a target="_blank" title="Get information on choosing a RAM." href="#">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="input-group input-group-sm">
							<select class="form-control" name="m22" id="m22" onchange="get_options('m22'); get_total();">
								<optgroup>
									<option value="0"></option>
								</optgroup>
								<optgroup>
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="checkbox">
							<input type="hidden" name="chassis" id="chassis" value="19003">
							<a target="_blank" href="#">Fractal Design Node 202</a>
						</div>
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="checkbox">
							<input type="hidden" name="psu" id="psu" value="20006">
							<a target="_blank" href="#">SilverStone SFX 450W (80 PLUS Gold)</a>
						</div>
					</div>
				</div>
				<div class="form-group row">
